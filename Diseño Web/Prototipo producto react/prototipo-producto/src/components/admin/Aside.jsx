...
const Aside = () => {
  ...
  const handleOpenSubMenu = (submenu) =>
    setVisibility({ ...visibilityInit, [submenu]: !visibility[submenu] });
...
<<<<<<< HEAD
  useEffect(() => {
    ...
    setActualPageAndAction({
      action: actualPathSplitted[2],
      page: actualPathSplitted[1],
    });
...
>>>>>>> e7fdd7fc5d9e534ae399f3ffc70898358b3e39fb
      ...
      <ul className="aside_menu">
        <li className={`aside_menu_item ${!(rol === "JEFE") && "opacity"}`}>
          ...
          >
            <FontAwesomeIcon
              icon={faUser}
              className="aside_menu_item_container_icon"
            />
            <span>Usuarios</span>
            <FontAwesomeIcon
              icon={faChevronDown}
          ...
          {!(rol === "JEFE") && (
            <div className="wrapper-menu" onClick={handleBlockRoute}></div>
          )}
        </li>
        ...
        <li className="aside_menu_item">
          <div
            className="aside_menu_item_container"
            onClick={() => handleOpenSubMenu("generals")}
          >
            <FontAwesomeIcon
          ...
          {visibility.generals && (
            <ul>
              <li
                onClick={() => navigate("/admin/generals/categorys")}
                className={
                  action === "categorys" && page === "generals"
                    ? "selected"
                    : ""
                }
              >
              ...
              <li
                onClick={() => navigate("/admin/generals/sizes")}
                className={
                  action === "sizes" && page === "generals" ? "selected" : ""
                }
              >
                Talles
              </li>
              ...
              <li
                onClick={() => navigate("/admin/generals/designs")}
                className={
                  action === "designs" && page === "generals" ? "selected" : ""
                }
              >
                Diseños
              </li>
              ...
              <li
                onClick={() => navigate("/admin/generals/supplier")}
                className={
                  action === "supplier" && page === "generals" ? "selected" : ""
                }
              >
                Proveedores
              </li>
          ...
          {(visibility.products || visibility["products-promo"]) && (
            <ul>
              <li
                ...
                className={
                  action === "create" &&
                  (page === "products" || page === "products-promo")
                    ? "selected"
                    : ""
                }
              >
                Añadir un nuevo producto / promo
              </li>
              ...
              <li
                ...
                className={
                  ...
                  action === "edit-product" ||
                  action === "edit-model" ||
                  (action === "edit-promo" && page === "products")
                    ? "selected"
                    : ""
                }
              >
                Listar productos / promociones
              </li>
              <li
                onClick={() => navigate("/admin/products/buy")}
                className={
                  action === "buy" && page === "products" ? "selected" : ""
                }
              >
                Compra
              </li>
              <li
                ...
                className={
                  action === "buy-list" ||
                  (action === "buy-details" && page === "products")
                    ? "selected"
                    : ""
                }
              >
        ...
        <li className="aside_menu_item">
          <div
            className="aside_menu_item_container"
            onClick={() => handleOpenSubMenu("sales")}
          >
            <FontAwesomeIcon
              icon={faShippingFast}
              className="aside_menu_item_container_icon"
          ...
          {visibility.sales && (
            <ul>
              <li
                onClick={() => navigate("/admin/sales/manage")}
                className={
                  action === "manage" && page === "sales" ? "selected" : ""
                }
              >
                Gestionar envios
              </li>
