                                    ...
                                    </tr>
                                    {
                                        employees.map(employe => (
                                            <tr key={employe.employee_user}>
                                                ...
                                                <td>{employe.state}</td>
                                                <td className="controls-table" onClick={() => navigate(`/admin/users/edit/${employe.employee_user}`)} ><FontAwesomeIcon icon={faPencil} /></td>
                                                {
                                                    employe.state === '1'
                                                    ? <td className="warning-control" onClick={ () => handleDisableUser(employe.employee_user)}><FontAwesomeIcon icon={faTrash}  /></td>
                                                    : <td className="warning-control" onClick={ () => handleEnableUser(employe.employee_user)}><FontAwesomeIcon icon={faCheck}  /></td>
                                                }
