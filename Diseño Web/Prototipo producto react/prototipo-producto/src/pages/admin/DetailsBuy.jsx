...
const DetailBuys = () => {
    ...
    const { infoResponsible, infoSupplier, details, totalSupply, idSupply } = detailsBuy;
    ...
    return (
        <ContainerBase>
            <section className="container_section detail-buys flex-column-center-xy">
                {
                    (infoResponsible && infoSupplier && details && totalSupply && idSupply)
                        ?
                        <>
                            <h1> {`Detalles de la compra con ID: ${idSupply} `}</h1>
