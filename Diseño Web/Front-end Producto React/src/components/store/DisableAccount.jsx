      ...
      if (result.isConfirmed) {
        try {
          const resp = await fetchApi(
            "auth-customers.php?url=disableAccount",
            "PUT",
            {
  ...
  return (
    ...
    >
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        <p className="warning">
          <FontAwesomeIcon className="warningIcon" icon={faExclamationCircle} />{" "}
          Cuidado, si desactivas tu cuenta no podrás volver a recuperarla
        </p>
        <div>
          <div
            style={{
        ...
        <button
          ...
          type="submit"
          disabled={thisPassword.length < 6}
        >
          Desactivar
        </button>
      </form>
