...
do
	...
	then
		...
		clear
		./Scripts/admininstracion/menuMonitoreo.sh
		;;
		7)
		...
		*)
		...
		logger -p local1.info "Se intento ingresar un valor no numerico"
		echo "Se ingreso un valor que no era un numero, error"
